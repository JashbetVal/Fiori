		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "invoices List",
									"targetURL": "#Jashinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Jashinvoices-display": {
								"semanticObject": "Jashinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Jash.invoices",
									"url": sap.ui.require.toUrl("Jash/invoices")
								}
							}
						}
					}
